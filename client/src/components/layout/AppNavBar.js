...
import { faCommentDollar, faSignal, faHome, faNewspaper, faSms, faEnvelopeOpenText, faUserPlus, faUsers, faSignInAlt, faSignOutAlt  } from '@fortawesome/free-solid-svg-icons'; 
